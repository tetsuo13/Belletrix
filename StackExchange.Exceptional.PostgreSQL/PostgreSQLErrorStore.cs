...
namespace StackExchange.Exceptional.PostgreSql
{
    public sealed class PostgreSQLErrorStore : ErrorStore
    {
        ...
        {
            get { return "PostgreSQL Error Store"; }
        }
...
Update Exceptions 
 ...
 Where GUID In @guids", new {guids}) > 0;
        ...
        /// <summary>
        ///     Deletes an error, by setting DeletionDate to UTC NOW in SQL
        /// </summary>
...
Update Exceptions 
 ...
 Where GUID = @guid 
   And DeletionDate Is Null", new {guid, ApplicationName}) > 0;
        ...
        /// <summary>
        ///     Deletes errors, by setting DeletionDate to UTC NOW in SQL
        /// </summary>
...
Delete From Exceptions 
 Where GUID = @guid
   And ApplicationName = @ApplicationName", new {guid, ApplicationName}) > 0;
        ...
        /// <summary>
        ///     Deleted all errors in the log, by setting DeletionDate to UTC NOW in SQL
        /// </summary>
