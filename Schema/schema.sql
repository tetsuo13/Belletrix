...
('Bouvet Island', 'BV', 0),
('Brazil', 'BR', 0),
('British lndian Ocean Territory', 'IO', 0),
...
('Guyana', 'GY', 0),
('Haiti', 'HT', 0),
('Heard and Mc Donald Islands', 'HM', 0),
('Honduras', 'HN', 0),
('Hong Kong', 'HK', 0),
('Hungary', 'HU', 0),
('Iceland', 'IS', 0),
...
('Svalbard and Jan Mayen Islands', 'SJ', 0),
('Syria', 'SY', 0),
('Tanzania', 'TZ', 0),
('Vatican City', 'VA', 0),
('Virgin Islands (British)', 'VG', 0),
('Spanish-speaking', 'SS', 1);
